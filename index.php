        ...
        len = data_in.length;
            ...
            function ajouter(data_in)
            {
                ...
                if (longueurTab > 0)
                {
                    ...
                    {
                        monPanier.ajouterArticle(parseInt(tableau.rows[i].cells[0].innerHTML), tableau.rows[i].cells[1].innerHTML,parseInt(tableau.rows[i].cells[2].innerHTML), parseFloat(tableau.rows[i].cells[3].innerHTML),parseFloat(tableau.rows[i].cells[4].innerHTML));
                        tableau.deleteRow(i);
                    }
                }
                ...
                for(var i = 0 ; i < longueur ; i++)
                {
                    ...
                    colonne4.innerHTML += ligne.getPrix();
                    var colonne5 = ligneTableau.insertCell(4);
                    colonne5.innerHTML += ligne.getPrixLigne();
                    var colonne6 = ligneTableau.insertCell(5);
                    colonne6.innerHTML += "<button class=\"btn btn-danger\" type=\"submit\" onclick=\"supprimer(this.parentNode.parentNode.cells[0].innerHTML)\"><span class=\"glyphicon glyphicon-remove\"></span> Remove</button>";
            ...
            function supprimer(code)
            {
                ...
                if (longueurTab > 0)
                {
                    for(var i = longueurTab ; i > 0  ; i--)
                    {
                        monPanier.ajouterArticle(parseInt(tableau.rows[i].cells[0].innerHTML), tableau.rows[i].cells[1].innerHTML,parseInt(tableau.rows[i].cells[2].innerHTML), parseFloat(tableau.rows[i].cells[3].innerHTML));
                        tableau.deleteRow(i);
                    }
                }
...
<img src="tarif-CM-2018-2.jpg" class="w3-round w3-image w3-opacity-min fancybox" alt="Menu" style="width:100%">
  ...
  <div class="w3-col l6 orders">
    ...
    <section  class="container">
            <article class=" form-inline pull-left col-lg-5">
